...
class SatSpider(scrapy.Spider):
    ...
    start_urls = ['https://ti.smartstudy.com/api/textbook/question-packages?examinationId=6&subjectId=&pageSize=9',
                  'https://ti.smartstudy.com/api/textbook/question-packages?examinationId=6&textbookId=43&name=13套&subjectId=&pageSize=20',
                  'https://ti.smartstudy.com/api/textbook/question-packages?examinationId=6&textbookId=91&name=SAT巴朗&subjectId=&pageSize=20',
                  'https://ti.smartstudy.com/api/textbook/question-packages?examinationId=6&textbookId=102&name=SAT精选词汇&subjectId=&pageSize=20',
                  'https://ti.smartstudy.com/api/textbook/question-packages?examinationId=6&textbookId=104&name=SAT核心词汇&subjectId=&pageSize=20']
    custom_settings = {
        'ITEM_PIPELINES': {'xzspider.SATpipelines.SATPipeline': 300, }
    }
                    ...
                    if subjects.__contains__("practiceList"):
                        for practice in subjects["practiceList"]:
                            ...
                            for index, questionId in enumerate(practice["questionIds"]):
                                ...
                                question["question_order"] = index
                                url = "https://ti.smartstudy.com/api/question/" + str(questionId)
                                yield Request(url=url, meta={'question': question}, callback=self.parse_writing)
                elif subjectName == "单词":
                    module_type = 5
                    for practice in subjects["practiceList"]:
                        article_id = uuid.uuid1()
